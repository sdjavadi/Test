...
class TemporalTracker:
    ...
    def _turnover_one_side(self, curr, prev, key, other, prefix):
        ...
        # amount-weighted turnover sibling: share of THIS month's amount on
        # counterparties retained from last month
        stat[f"recurring_{prefix}_amount_share"] = (
            1.0 - stat[f"new_{prefix}_amount_share"].fillna(0.0))
