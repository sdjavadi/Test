...
def run(data_dir: str = DATA_DIR, out_dir: str = OUT_DIR,
    ...
    # observed-vs-inferred confusion, node_type churn against the v5 rule,
    # and the outer-join profile — written every run, read before any
    # composition share is briefed
    ...
    attrs = customers.attrs.merge(
        customers.typing[[c for c in TYPING_COLS
                          if c in customers.typing.columns]],
        on="node", how="left")
